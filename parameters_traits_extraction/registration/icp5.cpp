...
{
   //加载点云文件
   PointCloud::Ptr cloud_src (new PointCloud);//原点云，待配准
//    pcl::io::loadPCDFile ("1.pcd",*cloud_src);  
   pcl::io::loadPCDFile ("/home/jianzhui/pcl-codes/datasets/maize/maize3/7/sor/000.pcd",*cloud_src);
   PointCloud::Ptr cloud_tgt(new PointCloud);//目标点云
   pcl::io::loadPCDFile ("/home/jianzhui/pcl-codes/datasets/maize/maize3/7/sor/240.pcd",*cloud_tgt);
//    pcl::io::loadPCDFile ("1.pcd",*cloud_tgt);
   ...
   *sac_result += *cloud_tgt;
   pcl::io::savePCDFileASCII("sacia.pcd",*sac_result);
   ...
   *icp_result += *cloud_tgt;
   pcl::io::savePCDFileASCII("after.pcd",*icp_result);

    // 创建 PCLVisualizer 对象
    pcl::visualization::PCLVisualizer viewer("PointCloud Viewer");
    viewer.addPointCloud(icp_result, "cloud1");
    viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_COLOR, 0, 255, 0.0, "cloud1");

    viewer.addPointCloud(cloud_tgt, "cloud2");
    viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_COLOR, 255, 0, 0, "cloud2");
    // 显示坐标轴
    // viewer.addCoordinateSystem(1.0);
